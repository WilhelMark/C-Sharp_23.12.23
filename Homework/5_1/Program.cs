...
class UserInputToCompileForTest
{
    ...
    public static int FindElementByPosition(int[,] array, int x, int y)
    {
        ...
        {
            Console.WriteLine("Position by rows goes beyond the array");
            return -1;
        }
        else if (y > array.GetLength(1))
        {
            Console.WriteLine("Position by columns goes beyond the array");
            return -1;
        }
        else
        {
    ...
    public static void PrintResult(int[,] numbers, int x, int y)
    {
        ...
        {
            Console.WriteLine("Position by rows or columns goes beyond the array");
        }
    }
}
